...
#
project-new --named bookstore --top-level-package com.oltruong.bookstore --build-system JAVA_EE_7 ;
...
constraint-add --on-property price --constraint NotNull ;
...
jpa-new-field --named book --type com.oltruong.bookstore.model.Book --relationshipType One-to-One ;
...
jpa-new-field --named orderLines --type com.oltruong.bookstore.model.OrderLine --relationshipType One-to-Many ;
